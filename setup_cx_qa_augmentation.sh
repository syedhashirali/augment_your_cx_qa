...
echo -e "${GREEN}========================================${NC}"
echo ""
echo -e "${BLUE}Augment Your QA Analysis! Your QA Analysis app is now ready!${NC}"
echo ""
echo -e "${YELLOW}Access your app at:${NC}"
echo -e "   http://$PUBLIC_IP"
echo -e "${YELLOW} If you are running the app on AWS Ubuntu Instance Access your app via SSH by running following on your local machine:${NC}"
echo -e "   ssh -i /path/to/your_aws_key.pem ubuntu@$PUBLIC_IP"
echo ""
